...
// GetEntrier mocks base method.
func (m *MockStore) GetEntrier(arg0 context.Context, arg1 int64) (db.Entry, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetEntrier", arg0, arg1)
	ret0, _ := ret[0].(db.Entry)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetEntrier indicates an expected call of GetEntrier.
func (mr *MockStoreMockRecorder) GetEntrier(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetEntrier", reflect.TypeOf((*MockStore)(nil).GetEntrier), arg0, arg1)
}
